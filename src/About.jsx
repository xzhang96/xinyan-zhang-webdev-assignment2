        ...
        return (
            ...
            <Container className="about">
                ...
                <ul>
                    ...
                    <li>The initial cells have 10% chance of being alive</li>
                ...
                <h3>Links:</h3>
                <ul>
                    <li>Website: <a href="https://xinyan-zhang-webdev-a2.herokuapp.com/">https://xinyan-zhang-webdev-a2.herokuapp.com/</a></li>
                    <li>Github: <a href="https://github.com/xzhang96/xinyan-zhang-webdev-assignment2">https://github.com/xzhang96/xinyan-zhang-webdev-assignment2</a></li>
                </ul>
            </Container>
            </>
        );
